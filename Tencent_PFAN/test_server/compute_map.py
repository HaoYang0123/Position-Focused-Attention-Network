...
def load_data_from_PFAN(dist_paths, flag_path):
    url_list = []
    dist_list = []
    flag_list = []
    ...
    for dist_path in dist_paths:
        ...
        for key in tmp_dict:
            if key not in url_dist_dict:
                url_dist_dict[key] = tmp_dict[key]
                url_count[key] = 1
            else:
                url_dist_dict[key] += tmp_dict[key]
                url_count[key] += 1
...
if __name__ == "__main__":
    ...
    #dist_files = ['./dist_tag_new_t2i.json', './dist_tag_i2t.json']
    url_list, dist_list, flag_list = load_data_from_PFAN(dist_files, "../data/tencent_data_meta/test_list.json")
